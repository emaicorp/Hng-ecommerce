...
const Product = ({ selectedCategory, priceFilter }) => {
  ...
  const api = `/products?organization_id=${process.env.REACT_APP_TIMBU_ORGANIZATION_ID}&reverse_sort=false&page=1&size=10&Appid=${process.env.REACT_APP_TIMBU_APP_ID}&Apikey=${process.env.REACT_APP_TIMBU_CLOUD_PUBLIC_KEY}`;
